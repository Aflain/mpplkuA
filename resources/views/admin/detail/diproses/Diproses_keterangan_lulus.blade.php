...
<div class="card-box">
           <div class="card-header"> 
             <h3> STATUS SURAT </h3>                
<h4>
@if($daftarSKL->status_surat == 'Diproses')
    <span class="badge label-table badge-warning">
@endif
@if($daftarSKL->status_surat == 'Selesai')
    <span class="badge label-table badge-success">
@endif
{{$daftarSKL->status_surat}}
</span>
</h4>
...
<form method="POST" action="{{route('update-suratketeranganlulus', $daftarSKL->id)}}">
{{ csrf_field() }}
<div class="row">
    <div class="col-4">
