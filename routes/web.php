...
Route::prefix('user')->group( function(){
    ...
    Route::get('/register','App\Http\Controllers\UsersRegistrationController@create');
    Route::post('/register', 'App\Http\Controllers\UsersRegistrationController@store')->name('user-register');
